...
def chromeBrowserOptions():
    ...
    # Utilisation de config pour accéder aux paramètres
    ...
    chrome_profile_path = config.get("chromeProfilePath")
    if chrome_profile_path:
        initialPath, profileDir = chrome_profile_path.rsplit('/', 1)
...
def donate(self):
    ...
    try:
        self.driver.get('africanovatech.com/')
